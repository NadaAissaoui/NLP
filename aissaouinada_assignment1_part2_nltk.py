# -*- coding: utf-8 -*-
"""AissaouiNada-assignment1_Part2_NLTK.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/12Cwsem30n7Mkxxt2kgHAqDvSELBwAkd_
...
def question_four():
    ...
    result = [word for word in fdist
              if len(word) > 5 and fdist[word] > 150]
...
def question_six():
    ...
    result = [(fdist[w], w) for w in fdist
              if w.isalpha() and fdist[w] > 2000]
...
def question_seven():
    ...
    for sent in sentences:
        total_tokens += len(word_tokenize(sent))
...
def question_nine():
    ...
    stems = [stemmer.stem(w.lower()) for w in text1 if w.isalpha()]
